...
const PROMPT_LEAK_PATTERNS = [
  ...
  /\bpreserving the original tone, warmth\b/i,
  /\bpreserving the original tone and level of formality\b/i,
  /\bkeeping specific details like names, numbers\b/i,
  /^you need me to translate\b/i,
  /^you want me to translate\b/i,

...
const verbosityInstruction = {
    ...
    normal: "Give complete, professional answers with useful detail, clear structure, direct steps, and a clean finish.",
    detailed: "Give detailed explanations, examples, edge-case notes, and practical guidance when useful.",
};
...
export const buildSystemPrompt = (input) => {
    const memoryBlock = input.memories.length === 0
        ? "No pinned memory."
        : input.memories

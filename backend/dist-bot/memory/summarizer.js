...
export class ConversationSummarizer {
    ...
    async summarizeIfNeeded(chat) {
        ...
        if (pendingCount < this.minNewMessagesToSummarize)
            return;
        ...
        const transcript = pending
            ...
            const content = message.content.length > 900
        ...
        try {
            ...
            logger.warn({ chatId: chat.id, error: error instanceof Error ? error.message : String(error) }, "Failed to update conversation summary");
        }
    }
}

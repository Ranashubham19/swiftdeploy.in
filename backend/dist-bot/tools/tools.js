...
import { isCodeToolEnabled, isProcessCodeToolEnabled, runCodeSubprocessTool, runJsSandbox, validateJsSyntax, } from "./codeRunner.js";
...
const rewriteText = (text, tone = "professional") => {
...
export const TOOL_SCHEMAS = [
    ...
    },
    {
        ...
        function: {
            ...
            description: "Run simple JavaScript in a restricted sandbox (console.log only). Disabled unless CODE_TOOL_ENABLED=true.",
            parameters: {
                type: "object",
                properties: {
                    code: { type: "string" },
    ...
    },
    {
        ...
        function: {
            ...
            description: "Run JavaScript or Python code in a subprocess with timeout and stdout/stderr capture. Disabled unless CODE_TOOL_ENABLED=true and ADVANCED_CODE_EXECUTION_ENABLED=true.",
            parameters: {
                type: "object",
                properties: {
                    code: { type: "string" },
...
export const shouldEnableTools = (text) => {

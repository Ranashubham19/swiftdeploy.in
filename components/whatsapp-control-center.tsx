      ...
      <div className={styles.grid}>
        <section className={styles.panel}>
          ...
          <form className={styles.form} onSubmit={handleSettingsSubmit}>
            <label className={styles.field}><span>Automation mode</span><select className={styles.select} value={settings.automationMode} onChange={(event) => setSettings((current) => ({ ...current, automationMode: event.target.value as WhatsAppSettings["automationMode"] }))}><option value="read_only">Read only</option><option value="suggest_only">Suggest only</option></select></label>

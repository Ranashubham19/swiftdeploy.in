      ...
      <div className={styles.grid}>
        <section className={styles.panel}>
          ...
          <form className={styles.form} onSubmit={handleSettingsSubmit}>
            <label className={styles.field}><span>Automation mode</span><select className={styles.select} value={settings.automationMode} onChange={(event) => setSettings((current) => ({ ...current, automationMode: event.target.value as WhatsAppSettings["automationMode"] }))}><option value="auto_reply">Auto reply</option><option value="read_only">Read only</option><option value="suggest_only">Suggest only</option></select></label>
            ...
            <div className={styles.switchGroup}>
              <label className={styles.toggle}><input type="checkbox" checked={false} disabled /><span>Manual approval gates are disabled globally</span></label>
              ...
              <label className={styles.toggle}><input type="checkbox" checked={false} disabled /><span>New-contact approval is retired</span></label>
              <label className={styles.toggle}><input type="checkbox" checked={false} disabled /><span>First-outreach approval is retired</span></label>
              ...
              return (
                <article key={workflow.id} className={styles.contactCard}>
                  ...
                  <div className={styles.switchGroup}>
                    ...
                    <label className={styles.toggle}><input type="checkbox" checked={false} disabled /><span>Approval gates disabled globally</span></label>
                  </div>
                  <div className={styles.inlineFields}>
